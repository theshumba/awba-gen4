...
- **Design authority**: THE ATHAR SYSTEM (`.planning/ATHAR-SYSTEM.md` + `.planning/phases/03-components-icon-kit-motion-language/03-UI-SPEC-ATHAR.md`), locked at Gate 2 on 2026-07-12 — five registers, Kiswah/cream grounds, rationed faces (Readex/Amiri/Marcellus/Aref Ruqaa/Courier/Rakkas). Josh's Gen-3 LOOK is retired (unit colours, lantern companion mascot, Poppins/Inter, gummy press, confetti/PERFECT, amber mercy) — his MECHANICS and CONTENT remain the byte-preserved ground truth. Per-phase CONTEXT translation tables (04-CONTEXT D-45, 05-CONTEXT D-53..61) are the binding reading of any retired vocabulary in REQUIREMENTS.md
